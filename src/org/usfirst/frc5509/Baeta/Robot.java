...
public class Robot extends IterativeRobot {
	...
	public void robotInit() {
		...
		switchB = new DigitalInput(2);
		switchC = new DigitalInput(3);
	...
	public void autonomousInit() {
		...
		if (switchA.get() == true && switchB.get() == true && switchC.get()) {
			ballPokeIn.start();
		}
	...
	public void teleopPeriodic() {
		...
		if (ball_launchin != 0) {
			...
			// FIXED
			/*
			 * try { Thread.sleep(800); } catch (InterruptedException e1) { //
			...
			// FIXED, Yet not. We must move thread.sleep into a different place
			// or fire pneumatis on its own button.
			/*
			 * try { Thread.sleep(800); } catch (InterruptedException e1) { //
			 * TODO Auto-generated catch block e1.printStackTrace(); }
			 * 
